...
module.exports = ".navbar-brand {\n  padding: 5px;\n}\n\n.navbar-brand img {\n  height: 100%;\n  display: inline-block;\n}\n\n.search{\n    overflow: hidden;\n    margin-bottom: 20px;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "<nav class=\"navbar navbar-default\">\n\t<div class=\"container-fluid\">\n\t\t<div class=\"navbar-header\">\n\t\t\t<a class=\"navbar-brand\" routerLink=\"/\">\n\t\t\t\t<img\n          alt=\"{{ APPLICATION_MAIN_TITLE }} Logo\"\n          src=\"https://cdn.jsdelivr.net/gh/iamramkey/altimetric@master/src/assets/after-math.png\"\n        />\n      </a>\n    </div>\n    <!-- /.navbar-collapse -->\n  </div>\n  <!-- /.container-fluid -->\n</nav>\n\n<div style=\"height: calc(100% - 72px)\">\n  <div class=\"search\">\n    <div class=\"col-xs-10\">\n      <input\n        type=\"text\"\n        placeholder=\"Search...\"\n        class=\"form-control\"\n        [(ngModel)]=\"search\"\n        (input)=\"onSearchValueChange($event)\"\n      />\n    </div>\n    <div class=\"col-xs-2\">\n      <button\n        class=\"btn btn-primary\"\n        [disabled]=\"\n          appModel?.emplyeesList?.length < 1 || search?.trim()?.length < 1\n        \"\n      >\n        Search\n      </button>\n      <button\n        class=\"btn btn-info\"\n        (click)=\"createNewUser()\"\n        style=\"margin-left: 2px;\"\n      >\n        Create\n      </button>\n    </div>\n  </div>\n  <ag-grid-angular\n    style=\"width: 100%; height: calc(100% - 54px)\"\n    class=\"ag-theme-balham\"\n    [gridOptions]=\"gridOptions\"\n  >\n  </ag-grid-angular>\n</div>\n\n<!-- Modal -->\n<ng-container *ngIf=\"editUser || createUser\">\n  <div class=\"modal-backdrop fade in\"></div>\n  <div class=\"modal fade in\" id=\"myModal\" role=\"dialog\" style=\"display: block;\">\n    <div class=\"modal-dialog\">\n      <!-- Modal content-->\n      <div class=\"modal-content\">\n        <div class=\"modal-header\">\n          <button\n            type=\"button\"\n            class=\"close\"\n            data-dismiss=\"modal\"\n            (click)=\"editUser = null; createUser = null\"\n          >\n            &times;\n          </button>\n          <h4 class=\"modal-title\">\n            {{ editUser ? \"Edit User\" : \"Create User\" }}\n          </h4>\n        </div>\n        <div class=\"modal-body\">\n          <form [formGroup]=\"profileForm\" class=\"clearfix\">\n            <div class=\"col-xs-12\">\n              <label>\n                First Name:\n                <input\n                  type=\"text\"\n                  class=\"form-control\"\n                  formControlName=\"first_name\"\n                />\n              </label>\n              <ng-container *ngIf=\"profileForm && profileForm?.controls?.first_name?.touched && profileForm?.controls?.first_name?.errors\">\n                  <div class=\"text-danger\" *ngIf=\"profileForm?.controls?.first_name?.errors?.required\">First Name is required</div>\n                  <div class=\"text-danger\" *ngIf=\"profileForm?.controls?.first_name?.errors?.minlength\">First Name should contain minimum {{ profileForm?.controls?.first_name?.errors?.minlength?.requiredLength }} characters</div>\n              </ng-container>\n            </div>\n\n            <div class=\"col-xs-12\">\n              <label>\n                Last Name:\n                <input\n                  type=\"text\"\n                  class=\"form-control\"\n                  formControlName=\"last_name\"\n                />\n              </label>\n              <ng-container *ngIf=\"profileForm && profileForm?.controls?.last_name?.touched && profileForm?.controls?.last_name?.errors\">\n                  <div class=\"text-danger\" *ngIf=\"profileForm?.controls?.last_name?.errors?.required\">Last Name is required</div>\n                  <div class=\"text-danger\" *ngIf=\"profileForm?.controls?.last_name?.errors?.minlength\">Last Name should contain minimum {{ profileForm?.controls?.last_name?.errors?.minlength?.requiredLength }} characters</div>\n              </ng-container>\n            </div>\n\n            <div class=\"col-xs-12\">\n              <label>\n                Email:\n                <input\n                  type=\"email\"\n                  class=\"form-control\"\n                  formControlName=\"email\"\n                />\n              </label>\n              <ng-container *ngIf=\"profileForm && profileForm?.controls?.email?.touched && profileForm?.controls?.email?.errors\">\n                  <div class=\"text-danger\" *ngIf=\"profileForm?.controls?.email?.errors?.required\">Email is required</div>\n                  <div class=\"text-danger\" *ngIf=\"profileForm?.controls?.email?.errors?.email\">Email should be valid</div>\n              </ng-container>\n            </div>\n\n            <div class=\"col-xs-12\">\n              <label>\n                Gender:\n                <select class=\"form-control\" formControlName=\"gender\">\n                  <option value=\"null\">Please select any gender</option>\n                  <option value=\"Male\">Male</option>\n                  <option value=\"Female\">Female</option>\n                </select>\n              </label>\n            </div>\n\n            <div class=\"col-xs-12\">\n              <label>\n                IP Address:\n                <input\n                  type=\"text\"\n                  class=\"form-control\"\n                  formControlName=\"ip_address\"\n                />\n              </label>\n            </div>\n\n            <div class=\"col-xs-12\">\n              <label>\n                Mac Address:\n                <input\n                  type=\"text\"\n                  class=\"form-control\"\n                  formControlName=\"mac_address\"\n                />\n              </label>\n            </div>\n\n            <div class=\"col-xs-12\">\n              <label>\n                Address:\n                <textarea\n                  class=\"form-control\"\n                  formControlName=\"address\"\n                ></textarea>\n              </label>\n              <ng-container *ngIf=\"profileForm && profileForm?.controls?.address?.touched && profileForm?.controls?.address?.errors\">\n                  <div class=\"text-danger\" *ngIf=\"profileForm?.controls?.address?.errors?.required\">Address is required</div>\n                  <div class=\"text-danger\" *ngIf=\"profileForm?.controls?.address?.errors?.minlength\">Address should contain minimum {{ profileForm?.controls?.address?.errors?.minlength?.requiredLength }} characters</div>\n              </ng-container>\n            </div>\n          </form>\n        </div>\n        <div class=\"modal-footer\">\n          <button\n            type=\"button\"\n            class=\"btn btn-danger\"\n            data-dismiss=\"modal\"\n            (click)=\"editUser = null; createUser = null\"\n          >\n            Close\n          </button>\n          <button\n            [disabled]=\"!profileForm?.valid\"\n            (click)=\"saveUser(editUser, editUser)\"\n            class=\"btn btn-primary\"\n            data-dismiss=\"modal\"\n          >\n            Save\n          </button>\n        </div>\n      </div>\n    </div>\n  </div>\n</ng-container>"
...
/* harmony import */ var _shared_app_model__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./shared/app.model */ "./src/app/shared/app.model.ts");
...
var AppComponent = /** @class */ (function () {
    function AppComponent(dataService, appModel) {
        var _this = this;
        this.dataService = dataService;
        this.appModel = appModel;
        this.gridOptions = {};
        this.APPLICATION_MAIN_TITLE = _shared_app_constants__WEBPACK_IMPORTED_MODULE_2__["APPLICATION_MAIN_TITLE"];
        this.profileForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormGroup"]({
            ...
            ip_address: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](null),
            mac_address: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](null),
        ...
        this.gridOptions.columnDefs = [
            ...
            },
            {
                ...
                cellRenderer: function (params) {
                    ...
                    edit.addEventListener("click", _this.onEditClick.bind(_this, params));
                    dlt.addEventListener("click", _this.onDeleteClick.bind(_this, params));
        ...
        this.dataService.getConfig().subscribe(function (data) {
            if (data instanceof Array) {
                _this.appModel.employeesData = data;
    ...
    AppComponent.prototype.onSearchValueChange = function (e) {
        this.gridOptions.api.setQuickFilter(e.target.value.trim());
    };
    AppComponent.prototype.onEditClick = function (params) {
    ...
    AppComponent.prototype.onDeleteClick = function (params) {
        var ind = this.appModel.employeesData.indexOf(params.data);
        if (ind > -1) {
            this.appModel.employeesData.splice(ind, 1);
            this.gridOptions.api.setRowData(this.appModel.employeesData);
        }
    };
    AppComponent.prototype.saveUser = function (editUser, isEdit) {
        if (isEdit === void 0) { isEdit = false; }
        if (isEdit) {
            var ind = this.appModel.employeesData.indexOf(editUser);
            if (ind > -1) {
    ...
    AppComponent.prototype.createNewUser = function () {
    ...
    AppComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_shared_data_service__WEBPACK_IMPORTED_MODULE_4__["DataService"], _shared_app_model__WEBPACK_IMPORTED_MODULE_3__["App"]])
    ], AppComponent);
    return AppComponent;
}());
...
/* harmony import */ var _shared_app_model__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./shared/app.model */ "./src/app/shared/app.model.ts");
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [_shared_data_service__WEBPACK_IMPORTED_MODULE_7__["DataService"], _shared_app_model__WEBPACK_IMPORTED_MODULE_6__["App"]]
        })
    ], AppModule);
    return AppModule;
}());
...
/*!*****************************************!*\
  !*** ./src/app/shared/app.constants.ts ***!
  \*****************************************/
/*! exports provided: APPLICATION_MAIN_TITLE */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "APPLICATION_MAIN_TITLE", function() { return APPLICATION_MAIN_TITLE; });
var APPLICATION_MAIN_TITLE = 'Employees List';


/***/ }),

/***/ "./src/app/shared/app.model.ts":
/*!*************************************!*\
  !*** ./src/app/shared/app.model.ts ***!
  \*************************************/
...
var DataService = /** @class */ (function () {
    function DataService(http) {
        this.http = http;
        this.configUrl = "https://raw.githubusercontent.com/iamramkey/altimetric/master/src/assets/employees.json";
    }
...
module.exports = __webpack_require__(/*! /Users/sampat/Personal/Works/git/altimetric/src/main.ts */"./src/main.ts");
